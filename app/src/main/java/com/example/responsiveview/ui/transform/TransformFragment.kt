...
import com.example.responsiveview.R
import com.example.responsiveview.databinding.FragmentTransformBinding
import com.example.responsiveview.databinding.ItemTransformBinding
...
class TransformFragment : Fragment() {
    ...
    class TransformAdapter(val listener: (string: String) -> Unit) :
